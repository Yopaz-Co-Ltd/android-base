...
class BGColorPickerDialog(
    private var onSetBGColor: (t: Int) -> Unit
) {
    ...
    fun show(
        ...
        var currentColor: Int = R.color.white
        ...
        if (dialog == null) {
            ...
            dialogTitle?.setText(R.string.dialog_background_text_color)
            ...
            colorPickerListView?.apply {
                adapter = BGColorPickerAdapter().apply {
